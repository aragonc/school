<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ---- HEADER ---- */
    .pdf-header { width: 100%; margin-bottom: 14px; border-bottom: 3px solid #1F4E79; padding-bottom: 10px; }
    ...
    /* ---- USER INFO ---- */
    .user-box { width: 100%; background: #F4F6F7; border: 1px solid #D5DBDB; border-radius: 6px; margin-bottom: 14px; }
    .user-box td { padding: 6px 10px; font-size: 10px; }
    .user-box .lbl { color: #777; font-weight: bold; width: 18%; }
...
<div class="pdf-header">
    <div class="pdf-header-title">{{ institution }} &mdash; Reporte Individual de Asistencia</div>
    {% if date_range %}
...
<!-- USER INFO -->
<table class="user-box" cellspacing="0" cellpadding="0">
    <tr>
    ...
    <tr>
        ...
        <td>{{ date_range ?: 'Todos los registros' }}</td>
    </tr>
</table>
